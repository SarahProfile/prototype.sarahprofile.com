...
<div class="elex_dp_wrapper">
	<div class="row">
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\Advanced Bulk Edit.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
		...
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\Dynamic Pricing & Discounts.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
		...
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\gpf.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
	...
	<div class="row">  
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\Catalog Mode.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
		...
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\Request a Quote.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
		...
		<div class="col-md-4">
			<div class="">
				<div class="">
					<img src="<?php echo esc_url( ELEX_PPCT_IMG_PATH . '\wschat.png' ); ?>" class="marketing_logos">
				</div>
			</div>
			<div class="">
				<div class="">
